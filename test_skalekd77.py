...
def test_crawl_skalekd77():
    """skalekd77 블로그 크롤링 테스트"""
    print("=" * 60)
    print("네이버 블로그 크롤러 - 실제 크롤링 테스트")
    print("=" * 60)
    print(f"블로그 ID: skalekd77")
    print(f"최대 포스트 수: 10개 (테스트용)")
    print("=" * 60)
    print()
    ...
    try:
        ...
        # 결과 파일로 저장
        output_path = f"output/test_crawl_skalekd77_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
